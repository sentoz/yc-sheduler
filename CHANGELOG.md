...
* Simplified calendar event blocks by replacing colored dots with event counts.
* Moved daily event count into the weekday header.

### Removed

* Unused legacy calendar styles.
...
[1.2.1]: https://github.com/sentoz/yc-sheduler/tree/v1.2.1
